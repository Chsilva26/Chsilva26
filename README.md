...
Sou estudante de Ciência da Computação (8º período) e profissional com experiência em desenvolvimento web, suporte técnico e automação industrial. Atuo de forma autônoma na criação de sites institucionais e soluções digitais para micro e pequenas empresas, com foco em usabilidade, desempenho e resultados práticos.
